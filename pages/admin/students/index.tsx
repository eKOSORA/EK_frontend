                  ...
                  <FormControl className="my-4 w-1/3 mx-4">
                    ...
                    >
                      ...
                      {classes.map((className) => (
                        <MenuItem key={Math.random()} value={className.value}>
                          {className.name}
                        </MenuItem>
                      ))}
                    </Select>
            ...
            <div className="w-1/2 my-auto flex flex-row items-center justify-around">
              <div className="my-4 float-right px-2 rounded-3xl w-8/12 font-questrial items-center justify-center flex text-lg neumorphism">
                ...
                <input
                  ...
                  className="hover:rotate-6 text-[#808080] outline-none w-[90%] border-none bg-inherit p-2.5 "
                />
              </div>
              ...
              <Link href={"/educator/students/new"}>
                <div
                  ...
                  className="hover:rotate-6 p-3 cursor-pointer rounded-full flex items-center justify-center text-[#808080] neumorphism"
                >
              ...
              <Link
                title="Go Back to students and their classes"
                href={"/educator/students/all"}
              >
