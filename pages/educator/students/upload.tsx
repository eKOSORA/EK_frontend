            ...
            {step === 1 ? (
              ...
              >
                <div className="flex items-center justify-start my-4 w-full">
                  ...
                  <span className="text-ek-blue text-3xl font-questrial">
                    Instructions
                  </span>
                </div>
                <div className="w-full flex items-start px-28 flex-col justify-start ">
                  <span className="text-xl text-black font-questrial">
                    There are some simple changes that you&apos;ll have to make
                    on your excel file to make it easier for our system to use.
                  </span>
                  <span className="flex items-start my-4 justify-start">
                    ...
                    <span className="text-xl w-11/12">
                      The first row should be in the following format. And the
                      columns must be arranged accordingly.
                    </span>
                  </span>
                </div>
                <div className="mx-auto hidden mxl:scale-90 xl:scale-100 my-8 bg-white mxl:flex flex-row items-center justify-center w-fit rounded h-fit">
                  <div className="text-base text-black px-4 py-1 border-r-2 border-r-ek-blue-50/70 mx-0 ">
                    First Name
                  </div>
                  <div className="text-base text-black px-4 py-1 border-r-2 border-r-ek-blue-50/70 mx-0 ">
                    Last Name
                ...
                <button
                  className="px-6 mt-8 absolute right-12 bottom-6 rounded text-white font-normal py-2 bg-ek-blue-75 cursor-pointer"
                  onClick={() => {
                    setStep(2);
                  }}
                >
                    ...
                    return (
                      ...
                      >
                        <input
                          ...
                          type="file"
                          id="excelFileToUpload"
                          className="hidden"
                          onChange={previewFile}
                          name="excelFileToUpload"
                        />
                        <label
                          className="w-full flex-col flex items-center justify-center"
                          htmlFor="excelFileToUpload"
                          id="excelFileToUploadLabel"
                        >
                          <Image
                            alt=""
                            width={200}
