    ...
    <div className='h-screen'>
      ...
      <div className='w-full flex items-center justify-start flex-col '>
        <div className='Feature py-[20px] px-[40px] mb-[20px] flex items-center justify-center relative w-11/12'>
          <div className='smm20:flex hidden'><Image height={'300px'} width={485} src={migrate} /></div>
        ...
        <div className='Feature py-[20px] px-[40px] mb-[20px] flex items-center justify-center relative w-11/12'>
          ...
          <div className='smm20:flex hidden'><Image height={'300px'} width={367} src={time} /></div>
        </div>

        <div className='Feature py-[20px] px-[40px] mb-[20px] flex items-center justify-center relative w-11/12'>
          <div className='smm20:flex hidden'><Image height={'300px'} width={320} src={speed} /></div>
          <div className='flex flex-col items-start justify-center w-full smm20:max-w-[600px]'>
