...
const GeneralEducatorDashboard: React.FC<Props> = ({ role }) => {
          ...
          <div className="w-full flex flex-col items-start my-8 justify-start  animate__animated animate__fadeInLeft">
            ...
            <div className="w-full flex flex-col items-center justify-center">
              <div className="rounded-[5px] neumorphism w-full bg-[#f0f0f0] flex flex-col items-start justify-start mb-[30px] h-[160px] p-[20px] relative">
                ...
                <span className="">
                  The students are starting to behave very wrong. I think that
                  the parents should allows us to beat the shit out there
                  children!
                </span>
                <span className="w-full text-end mt-[20px] text-[#0006]">
                  Posted by <strong>A.IV</strong> on{" "}
                  <strong>Thu Sep 01 2022</strong>
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="w-full flex flex-col items-start my-8 justify-start  animate__animated animate__fadeInLeft">
            ...
            <div className="w-full flex flex-row items-end justify-around">
              ...
              <div className="scale-75 relative p-10 w-4/12 pt-6 neumorphism rounded-lg">
                <h2 className="heading-text text-ek-blue text-4xl my-4">
                  Summary
                </h2>
                ...
                <div className="px-10 flex flex-col mb-3 items-start justify-start">
                  <div className="flex items-center justify-center">
                    <span className="text-lg text-gray-400 ">Class: </span>
                    <span className="text-lg text-black ml-2">Year 1 A</span>
                  </div>
                  <div className="flex items-center justify-center">
                    <span className="text-lg text-gray-400 ">Marks: </span>
                    <span className="text-lg text-black ml-2">87%</span>
                  </div>
                </div>
                ...
                <div className="px-10 flex flex-col mb-3  items-start justify-start">
                  <div className="flex items-center justify-center">
                    <span className="text-lg text-gray-400 ">Class: </span>
                    <span className="text-lg text-black ml-2">Year 1 B</span>
                  </div>
                  <div className="flex items-center justify-center">
                    <span className="text-lg text-gray-400 ">Marks: </span>
                    <span className="text-lg text-black ml-2">87%</span>
                ...
                <div className="w-full px-4 py-3 mt-3 absolute bottom-0 left-0 right-0 bg-ek-blue-50 rounded-b-lg text-white">
...
export default GeneralEducatorDashboard;
